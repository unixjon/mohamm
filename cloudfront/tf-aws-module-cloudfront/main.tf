  ...
  dynamic "origin" {
    ...
    content {
      ...
      dynamic "s3_origin_config" {
        ...
        content {
          origin_access_identity = lookup(s3_origin_config.value, "cloudfront_access_identity_path", lookup(lookup(module.origin_access_identity, lookup(s3_origin_config.value, "origin_access_identity", ""), {}), "cloudfront_access_identity_path", null))
        }
      }
...
module "origin_access_identity" {
  source                        = "modules/origin_access_identity"
  create_origin_access_identity = var.create_origin_access_identity
  origin_access_identities      = var.origin_access_identities
}

module "monitorin_subscription" {
  source                               = "modules/monitoring_subscription"
  cloudfront_distribution_id           = aws_cloudfront_distribution.this[0].id
