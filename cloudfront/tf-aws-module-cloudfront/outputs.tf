...
output "cloudfront_origin_access_identities" {
  ...
  value       = { for k, v in module.origin_access_identity : k => v if local.create_origin_access_identity }
}

output "cloudfront_origin_access_identity_ids" {
  description = "The IDS of the origin access identities created"
  value       = [for v in module.origin_access_identity : v.cloudfront_origin_access_identity_ids if local.create_origin_access_identity]
}

output "cloudfront_origin_access_identity_iam_arns" {
  description = "The IAM arns of the origin access identities created"
  value       = [for v in module.origin_access_identity : v.cloudfront_origin_access_identity_iam_arns if local.create_origin_access_identity]
}
...
output "cloudfront_monitoring_subscription_id" {
  ...
  value       = try(module.monitorin_subscription.cloudfront_monitoring_subscription_id, "")
}
