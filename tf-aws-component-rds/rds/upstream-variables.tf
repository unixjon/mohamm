...
variable "availability_zone" {
  description = "The Availability Zone of the RDS instance. Don't set unless you know what you're doing"
  type        = string
  default     = null
}
...
# Disabling enhanced monitoring stats for now. Will enable in future version of the component.
